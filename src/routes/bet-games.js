...
router.put('/me/bet/group/:id/:g', validar.isAuth,controller.updateMeBetGameGroup)//Actualiza apuesta usuario logueado y grupo del juego (ruta optimizada para el frontend)
